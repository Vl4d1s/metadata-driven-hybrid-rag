...
SET a.embedding = $accident_embedding'''
    ...
    accident_text_for_embedding = (
        ...
        f"Driver information: {driver_text_for_embedding}"
        f"\nDrived on car: {car1_text_for_embedding}"
        f"\nOwner information: {owner_text_for_embedding}"
    )
...
SET car2.embedding = $car2_embedding'''
        ...
        accident_text_for_embedding += f"\nOther Driver 1 info: {other_driver_1_text_for_embedding}"
        accident_text_for_embedding += f"\nOther Driver 1 car info: {car2_text_for_embedding}"
        car2_embedding = None
        try:
            embedder = OpenAIEmbeddings(model="text-embedding-ada-002")
...
SET car3.embedding = $car3_embedding'''
        ...
        accident_text_for_embedding += f"\nOther Driver 2 info: {other_driver_2_text_for_embedding}"
        accident_text_for_embedding += f"\nOther Driver 2 car info: {car3_text_for_embedding}"
        car3_embedding = None
        try:
            embedder = OpenAIEmbeddings(model="text-embedding-ada-002")
...
SET car4.embedding = $car4_embedding'''
        ...
        accident_text_for_embedding += f"\nOther Driver 3 info: {other_driver_3_text_for_embedding}"
        accident_text_for_embedding += f"\nOther Driver 3 car info: {car4_text_for_embedding}"
        car4_embedding = None
        try:
            embedder = OpenAIEmbeddings(model="text-embedding-ada-002")
    ...
    print("accident_text_for_embedding:", accident_text_for_embedding)
